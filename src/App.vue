            ...
            <div class="dropdown inline-block relative">
              ...
              <button class=" py-2 px-4 rounded inline-flex items-center" style="overflow:auto">
                   <li v-if="languageId=='en'"><img src="./assets/img/united-kingdom.png"  style="width:20px;margin-right:1rem" alt=""></li>
                    ...
                    <li v-if="languageId=='ar'"><img src="./assets/img/arabia.png"  style="width:20px;margin-right:1rem" alt=""></li>
                ...
                <li class=""><a class="py-2 px-4 block whitespace-no-wrap inline-flex" href="#" @click="switchLanguage('ar')"><img src="./assets/img/arabia.png" style="width:20px;margin-right:1rem" alt=""><i class="hover:text-gray-100">Ar</i></a></li>
...
#nav {
  ...
  a {
    ...
    &.router-link-exact-active {
      color: #df9523;
      text-decoration: underline solid #df9523;
